const nameGirl = 'Em ơi';
const giftUrl = 'http://nodemy.vn';
const eventName = 'Ấn vào đi';
const titleCard = 'Tặng em';
const contentCard = 'Chúc e bé của anh ngày mới tràn ngập niềm vui và những nụ cười. Mong điều đẹp nhất sẽ đến với em trong hôm nay và cả những ngày sau';
